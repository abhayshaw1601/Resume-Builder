            ...
            <div className="grid grid-cols-1 gap-6 bg-white/5 border border-white/10 rounded-2xl p-4">
                <div className="space-y-3">
                    <div className="flex justify-between items-center">
                        ...
                        <span className="text-xs font-mono text-[#A6FF5D] bg-[#A6FF5D]/10 px-2 py-0.5 rounded">{fontSize}px</span>
                    </div>
                    <input 
                        type="range" 
                        min="12" 
                        ...
                        step="1"
                        value={fontSize || 16}
                        onChange={(e) => handleLayoutChange('font_size', e.target.value)}
                ...
                <div className="space-y-3">
                    <div className="flex justify-between items-center">
                        <label className="text-xs uppercase tracking-widest text-gray-400 font-bold">Section Spacing</label>
                        <span className="text-xs font-mono text-[#A6FF5D] bg-[#A6FF5D]/10 px-2 py-0.5 rounded">{sectionSpacing}px</span>
                    </div>
                    <input 
                        type="range" 
                        min="10" 
