...
const StandardATSTemplate = ({ data, accentColor, accentBg, fontSize, sectionSpacing }) => {
    ...
    const SectionTitle = ({ children }) => (
        <h2
            className="text-sm font-bold uppercase tracking-[0.2em] pb-2 mb-4"
                    ...
                    <div className="space-y-4">
                        {data.experience.map((exp, i) => (
                            <div key={i}>
                                ...
                                {exp.description && (
                                    <ul className="mt-1.5 space-y-0.5 text-gray-700 text-sm">
                        ...
                        {data.project.map((p, i) => (
                            <div key={i}>
                                <div className="flex items-center gap-2">
                                    ...
                                    {p.link && (
                                        <a href={p.link} target="_blank" rel="noopener noreferrer" className="text-xs hover:underline" style={{ color: accentColor }}>↗ Link</a>
                                    )}
                                </div>
