...
const TimelineTemplate = ({ data, accentColor, accentBg, fontSize, sectionSpacing }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto bg-white text-gray-800 p-8" style={{ fontSize: fontSize || 15 }}>
            ...
            <header className="text-center mb-8 pb-6 border-b-2 border-gray-100">
                ...
                <div className="flex flex-wrap justify-center gap-4 text-xs text-gray-500 mt-3">
            ...
            {data.experience?.length > 0 && (
                <section style={{ marginBottom: sectionSpacing || 28 }}>
                    <h2 className="text-sm font-bold uppercase tracking-[0.2em] mb-6" style={{ color: accentColor }}>
                                ...
                                <div key={i} className="relative">
                                    ...
                                    <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                                        <div className="flex justify-between items-baseline">
                                            ...
                                            <span className="text-[11px] px-2 py-0.5 rounded-full text-gray-500 bg-white border border-gray-200 whitespace-nowrap ml-3">
                                        ...
                                        {exp.description && (
                                            <div className="mt-2 text-sm text-gray-600 leading-relaxed whitespace-pre-line">{exp.description}</div>
                                        )}
                                    </div>
                                </div>
                            ))}
            ...
            {data.project?.length > 0 && (
                <section style={{ marginBottom: sectionSpacing || 28 }}>
                    <h2 className="text-sm font-bold uppercase tracking-[0.2em] mb-5" style={{ color: accentColor }}>
                        Projects
                    </h2>
            ...
            {data.skills?.length > 0 && (
                <section>
                    <h2 className="text-sm font-bold uppercase tracking-[0.2em] mb-4" style={{ color: accentColor }}>
                        Skills & Expertise
                    </h2>
