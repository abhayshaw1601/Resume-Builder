        ...
        {!loading && allresume.map((resume) => (
          <div key={resume._id} className="relative w-full h-[400px]">
            ...
            >
              ...
              {/* Thumbnail Preview */}
              <div className="h-[280px] bg-white/5 border-b border-white/[0.06] relative overflow-hidden group-hover:opacity-80 transition-opacity flex justify-center pt-4">
